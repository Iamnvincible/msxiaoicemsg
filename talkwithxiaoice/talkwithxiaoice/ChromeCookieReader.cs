...
namespace talkwithxiaoice
{
    ...
    {
        public IEnumerable<Tuple<string, string>> ReadCookies(string hostName = ".weibo.com")
        {
            ...
            using (var cmd = conn.CreateCommand())
            {
                ...
                using (var reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        var decodedData = ProtectedData.Unprotect(encryptedData, null, System.Security.Cryptography.DataProtectionScope.CurrentUser);
